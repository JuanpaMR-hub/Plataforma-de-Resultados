...
from ..classes.embedtoken import EmbedToken
from ..classes.embedconfig import EmbedConfig
from ..classes.embedtokenrequestbody import EmbedTokenRequestBody
import requests
import json

class PbiEmbedService:
    def get_report(self, workspace_id, nombre_reporte):
        ...
        reports =  f'https://api.powerbi.com/v1.0/myorg/groups/{workspace_id}/reports'
        response_api = requests.get(reports, headers=self.get_request_header())
